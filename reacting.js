...
client.on('messageReactionAdd', (reaction, user) => {
    if (reaction.message.member.roles.cache.has('760635108067246110') && reaction.emoji.name == '🗑️') { 
...
Your ${reaction.message}`);}
    else if (reaction.message.member.roles.cache.has('760635108067246110') && reaction.emoji.name == '⭐') { 
